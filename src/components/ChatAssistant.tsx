  ...
  const generateResponse = (query: string): string => {
    ...
    if (
      ...
      if (
        ...
        return `Lalith maintains an impressive CGPA of 9.22 at VIT-AP University, which places him among the top performers in his class. During his intermediate education, he achieved a CGPA of 9.7 in challenging subjects like Mathematics, Physics, and Chemistry.`;
      }
